  ...
  return (
    <div className="min-h-screen font-sans selection:bg-cyan-500 selection:text-white pb-20 relative overflow-hidden bg-[radial-gradient(ellipse_at_top,_var(--tw-gradient-stops))] from-slate-900 via-[#090E24] to-black text-slate-200">
      ...
      <div className="relative z-10">
        ...
        {/* HEADER / HERO */}
        <header className="max-w-4xl mx-auto pt-20 px-6 mb-16 text-center md:text-left">
          ...
          <p className="text-slate-400 max-w-2xl mb-8 text-lg mx-auto md:mx-0">
          ...
          <div className="flex gap-4 justify-center md:justify-start">
            ...
            <a href="https://www.linkedin.com/in/ryanedwinruban" target="_blank" className="flex items-center gap-2 px-4 py-2 bg-blue-700 rounded-lg hover:bg-blue-600 transition">
              <Linkedin size={20} /> LinkedIn
            </a>
            <a href="mailto:edwinruban@et.esiea.fr" className="flex items-center gap-2 px-4 py-2 bg-slate-800 rounded-lg hover:bg-slate-700 transition border border-slate-700">
        ...
        <main className="max-w-4xl mx-auto px-6">
          ...
          <div className="grid gap-8">
            ...
            {/* PROJET 1 : HAVEN */}
            <div className="bg-slate-900/40 backdrop-blur-md p-6 rounded-xl border border-white/10 hover:border-cyan-500/50 transition duration-300 shadow-lg">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-20">
            <div className="bg-slate-900/40 backdrop-blur-md border border-white/10 p-4 rounded-lg text-center">
        ...
        <footer className="text-center text-slate-600 text-sm pb-8">
          <p>© 2025 - Portfolio réalisé avec React + Vite + Tailwind</p>
        </footer>
      </div>
    </div>
  )
